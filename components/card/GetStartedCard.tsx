  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        <h2 className="text-3xl font-bold mb-4">Get Started with GCX Cloud</h2>
        ...
        <button
          className="bg-white text-green-800 font-semibold px-6 py-2 rounded-full transition-all duration-300 hover:shadow-[0_0_15px_3px_rgba(34,197,94,0.5)]"
        >
          Get Start
        </button>
      </div>
