...
export default function ObjectStoragePricingPage() {
  ...
  useEffect(() => {
    const fetchPlans = async () => {
      try {
        const res = await fetch(`/api/pricing/Object Storage`);
        ...
        <div className="py-16 lg:py-32 md:py-32">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="px-4 lg:px-8 md:px-8">
              <DataTable columns={blockStorageColumns("Object Storage")} data={plans} />
            </div>
          </div>
        </div>
      </div>
